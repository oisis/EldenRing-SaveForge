...
### 🟡 Templates v2 — Phase 7c+: talismans / spells writers + multi-char pack

Continuation of the foundation + Phase 5 profile/stats Apply + Phase 6 apply-time overrides + Phase 6b weapon level override + Phase 9 URL import + Phase 7a v2 inventory.workspace Apply + Phase 7a.2 weapon level override on the v2 inventory.workspace path + Phase 7b.0 equipment writer foundation + Phase 7b.1 v2 `sections.equipment` end-to-end shipped above. v2 apply now covers profile, stats, inventory.workspace, and equipment (weapons + ammo + armor); talismans, spells, EquippedGreatRune through the template path, appearance, and multi-character pack remain future work.

- **Phase 7c** — new public write path for the 5 equipped talisman slots 17–21 (hash 8) and a `sections.equippedTalismans` schema section; strict "item must be in inventory" enforcement mirroring Phase 7b.1
