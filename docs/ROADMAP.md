...
Phase 0..4 of the design doc `spec/56-templates-v2.md`. v2 apply is enabled for profile/stats from the library and from an imported YAML directly (Phase 5 / 5D.2); sections outside profile/stats and Phase 6+ remain planned / blocked.
