...
| Zmiana kodu produkcyjnego | Phase 0..6 + Phase 6b + Phase 7a + Phase 7a.2 + Phase 7b.0 + Phase 7b.1 + Phase 9 dostarczone; późniejsze fazy pozostają wyłącznie design. Szczegóły w §17 i §17a. |
...
- Sloty equipped-talisman 17–21 — gated przez Phase 7c (nowy writer).
- 14-slot loadout EquippedSpells — gated przez Phase 7d (nowy writer).
