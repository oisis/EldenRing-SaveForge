...
| Production code change | Phase 0..6 + Phase 6b + Phase 7a + Phase 7a.2 + Phase 9 shipped; later phases remain design-only. Detail in §17 and §17a. |
...
Phase 7b+ work remains design-only in this document. Each phase requires a separate user approval before implementation per the workflow in `~/.claude/CLAUDE.md`.
