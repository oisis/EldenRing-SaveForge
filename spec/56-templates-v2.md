...
| Production code change | Phase 0..6 + Phase 6b + Phase 7a + Phase 7a.2 + Phase 7b.0 + Phase 7b.1 + Phase 9 shipped; later phases remain design-only. Detail in §17 and §17a. |
...
- Equipped-talisman slots 17–21 — gated by Phase 7c (new writer).
